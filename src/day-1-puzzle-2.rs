...
fn day_1_puzzle_2(init_pos: u8, rotations: Vec<String>) -> u64 {
    ...
    for rotation in rotations.iter() {
        ...
        let dist:i64 = chars.as_str().parse::<u64>().expect("Failed to parse distance as an integer") as i64;
        let quot: i64 = dist / 100;
        let rem: i64 = dist % 100;
        zero_count += quot as u64;
        if curr_pos != 0 {
            if multiplier == -1 && rem >= curr_pos || 
               multiplier == 1 && curr_pos + rem >= 100 {
                zero_count += 1;
            }
        }
...
mod tests {
    ...
    fn test_day_1_puzzle_2() {
        assert_eq!(day_1_puzzle_2(50, utils::str_slice_to_vec_string(&[
    ...
    fn test_day_1_puzzle_2_extended() {
        assert_eq!(day_1_puzzle_2(50, utils::str_slice_to_vec_string(&[
            "L68", "L30", "R48", "L5", "R60", "L55", "L1", "L99", "R14", "L82",
            "L32", "R1000", "L1000", "R1", "R1000", "L234", "R32", "R1000", "R99", "R202"
        ])), 54);
    }

    #[test]
    fn test_day_1_puzzle_2_improved() {
        assert_eq!(day_1_puzzle_2_improved(50, &utils::str_slice_to_vec_string(&[
            "L68", "L30", "R48", "L5", "R60", "L55", "L1", "L99", "R14", "L82",
        ])), 6);
    }
